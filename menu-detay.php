				...
				<div class="container">
					<div class="row pt-xl">
						...
						<div class="col-md-9">
							...
							<h1 class="mt-xl mb-none"><?php echo $menu_cek['menu_ad']; ?></h1>
									...
									<span class="thumb-info thumb-info-side-image thumb-info-no-zoom mt-xl">
										<span class="thumb-info-side-image-wrapper p-none ">
											<a title="" href="demo-law-firm-news-detail.html">
												<img src="<?php echo $menucek['menu_resimyol']; ?>" class="img-responsive" alt="" style="width: 395px;height: 250px;padding: 10px;">
											</a>
										</span>
										<span class="thumb-info-caption">
											<span class="thumb-info-caption-text">
												<h2 class="mb-md mt-xs"><a title="" class="text-dark" href="demo-law-firm-news-detail.html"><?php echo $menucek['menu_ad']; ?></a></h2>
