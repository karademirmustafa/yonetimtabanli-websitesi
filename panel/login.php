      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form action="netting/loginislem.php" method="POST">
              <h1>Yönetim Panel Girişi</h1>
              <div>
              ...
              <div>
               <button style="width: 100%; background-color:#73879C;color:white;" type="submit" name="login" class="btn btn-default">Giriş Yap</button>
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-paw"></i> Anadolu Gençlik Derneği</h1>
                  <p>©2020 All Rights Reserved.Anadolu Gençlik Derneği için kodlanmıştır.</p>
                </div>
              </div>
            </form>
          </section>
