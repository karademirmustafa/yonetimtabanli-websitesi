                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title text-center ">Hisse Türü </th>
                            <th class="column-title text-center">Ödeme Türü </th>
                            <th class="column-title text-center">Vekalet Verdi Mi ? </th>  
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="text-center"><?php echo $basvurucek['basvuru_hissetur']; ?></td>      
                            <td class="text-center"><?php echo $basvurucek['basvuru_odemeturu']; ?></td>                       
                            <td class="text-center"><?php echo $basvurucek['basvuru_vekalet']; ?></td>
