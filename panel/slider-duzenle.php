                ...
                <div class="x_panel">
                 <div class="x_title">
                  ...
                  <div class="x_content">
                   ...
                   <form action="netting/sliderduzenleislem.php" method="POST" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
