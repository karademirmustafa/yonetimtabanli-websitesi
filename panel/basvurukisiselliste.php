             ...
             <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                  ...
                  <form action="" method="POST">
                     <input type="hidden" name="basvuru_id" value="<?php echo $basvurucek['basvuru_id']; ?>">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title ">Telefon Numarası </th>
                            <th class="column-title ">Telefon Numarası 2 </th>
                            <th class="column-title ">E-Postası</th>  
                            <th class="column-title  ">Mesleği </th>                      
                            <th class="column-title ">Doğum Tarihi </th>
                            <th class="column-title ">Cinsiyeti </th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td ><?php echo $basvurucek['basvuru_telefon1']; ?></td>      
                            <td ><?php echo $basvurucek['basvuru_telefon2']; ?></td>                       
                            <td ><?php echo $basvurucek['basvuru_mail']; ?></td>
                            <td ><?php echo $basvurucek['basvuru_meslek']; ?></td>   
                            <td ><?php echo $basvurucek['basvuru_dogumtarihi']; ?></td>                           
                            <td ><?php echo $basvurucek['basvuru_cinsiyet']; ?></td>
